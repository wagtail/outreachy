...
👋 Hello everyone!! My name is Jude Tochy, my code name is `YoungAncient`. I'm a React JS, Next js and Typescript developer based in Nigeria, I am a writer and also manage a tech community in my university. I made it one of my goals to contribute to open source this year, and Outreachy is making come through!

When I'm not coding, I love to tinker, solve puzzles, watch Animes, movies and comedy skits on Youtube.
...
| Reach me @      
|---------------
| My [github](https://github.com/youngancient/)
| My [blog](https://youngancients.hashnode.dev/)
| My [twitter](https://twitter.com/judetochyx)
