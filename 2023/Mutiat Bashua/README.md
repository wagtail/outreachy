...
### Blogpost about my understanding of accessibility

- [Understanding Web Accessibility](https://dev.to/mutiatbash/understanding-web-accessibility-358n).

### Blogpost demonstrating my expertise in technical writing

- [Creating an instance in Amazon Web Services (AWS)](https://dev.to/mutiatbash/creating-an-instance-in-amazon-web-services-aws-39nf).
