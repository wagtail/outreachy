...
| Platform          | Link                                    |
|-------------------|-----------------------------------------|
| GitHub            | [GitHub](https://github.com/Amarajah) |
| Blog | [Medium](https://medium.com/@naomi.ibeh69)                |
| Twitter    | [Twitter](https://twitter.com/Amarajah7)      |
| Linkedin    | [Linkedin](www.linkedin.com/in/ibe-naomi)      |
...
I'm really keen on contributing to the "Wagtail.org website accessibility" project, but since I'm relatively new to Wagtail, I had to do much reading and research on the topic. I'm really interested in making Wagtail more accessible for everyone, as I believe that anyone should be able to access whatever resource they need to use despite whatever limitations they may have. Below are a list of resources I've found particularly helpful

| Platform          | Link                                    |
|-------------------|-----------------------------------------|
| Wagtail's Official Tutorial | [Wagtail](https://docs.wagtail.org/en/stable/getting_started/index.html) |
| Wagtail Setup | [Setting Wagtail Up](https://docs.wagtail.org/en/stable/contributing/developing.html)                |
| Wagtail's Official Website | [Wagtail.org](https://wagtail.org/)      |
| Wagtail's Github Repo | [Github](https://github.com/wagtail/wagtail.org)      |


## Recent Insights

Below is a link to things I've recently learned on my journey through tech/life. I hope you enjoy it :)

| Platform          | Link                                    |
|-------------------|-----------------------------------------|
| Medium | [Recent Insights](https://medium.com/@naomi.ibeh69/recent-insights-1d61fb2ef19b)      |
...
| Platform          | Link                                    |
|-------------------|-----------------------------------------|
| Medium | [Accessibility](https://medium.com/@naomi.ibeh69/accessibility-in-the-tech-field-aec0db447b9a)      |
